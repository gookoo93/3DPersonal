...
public class EnemyFOV : MonoBehaviour
{
    ...
    private const float wanderSpeed = 30f; // FOV 움직임 속도 조절
    ...
    void LateUpdate()
    {
        if (!patrol)
        {
            wanderAngle += wanderSpeed * Time.deltaTime;
            transform.rotation = Quaternion.Euler(0f, Mathf.Sin(wanderAngle) * 10f, 0f); // 좌우로 10도 움직임
        }
        DrawFieldOfView();
    }
